...
word8_100000000 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 100000000 (B.put @Word8 123)))
    , bench "stdio/buildBytes"     $ nf B.buildBytes (mconcat (replicate 100000000 (B.put @Word8 123)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 100000000 (B.put @Word8 123))))
    ]
...
word8_32 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 32 (B.put @Word8 123)))
    , bench "stdio/buildBytes"     $ nf B.buildBytes (mconcat (replicate 32 (B.put @Word8 123)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 32 (B.put @Word8 123))))
    ]
...
bytes_32_1000 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 32 (B.put bytes1000)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 32 (B.put bytes1000))))
    ]
...
bytes_32_20000 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 32 (B.put bytes20000)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 32 (B.put bytes20000))))
    ]
